...
public class ItemColorBindingImpl extends ItemColorBinding implements com.iqonic.woobox.generated.callback.OnClickListener.Listener {
    ...
    private ItemColorBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback20 = new com.iqonic.woobox.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.iqonic.woobox.models.Color) variable);
        }
    ...
    public void setModel(@Nullable com.iqonic.woobox.models.Color Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.iqonic.woobox.models.Color model = mModel;
